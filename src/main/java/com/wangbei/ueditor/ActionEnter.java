...
import com.wangbei.ueditor.hunter.FileManager;
import com.wangbei.ueditor.hunter.ImageHunter;
import com.wangbei.ueditor.upload.Uploader;
	...
	public String invoke() {
		...
		switch ( actionCode ) {
			...
			case ActionMap.CONFIG:
				return JacksonUtil.encode(this.configManager.getAllConfig());
