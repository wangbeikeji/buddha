...
public class MessagePushController {
	...
	@GetMapping("/push")
	@ApiOperation(value = "根据RegistrationId推送")
	public Response<String> push(String registrationId, String title, String alert) {
		Map<Integer, String> userIdRegistrationIdMap = new HashMap<>();
		jiguangService.pushBatchNotification(userIdRegistrationIdMap, 0, title, alert, PushTypeEnum.FeastDayRemind);
