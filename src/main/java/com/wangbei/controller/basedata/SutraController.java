...
public class SutraController {
	...
	public Response<String> collectData(int collectType, String resource,
			@RequestParam(required = false) int sutraType) {
		sutraService.collectSutraData(collectType, resource, SutraTypeEnum.getByIndex(sutraType));
