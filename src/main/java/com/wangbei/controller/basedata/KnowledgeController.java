...
public class KnowledgeController {
	...
	@ApiOperation(value = "根据类型获取佛学知识分页数据（1:资讯,2:故事,3:入门,4:养生,5:名刹）")
	...
	@ApiOperation(value = "根据类型获取佛学知识列表（1:资讯,2:故事,3:入门,4:养生,5:名刹）")
	...
	@ApiOperation(value = "根据类型获取佛学知识列表（后台管理使用）", notes="1:资讯,2:故事,3:入门,4:养生,5:名刹")
