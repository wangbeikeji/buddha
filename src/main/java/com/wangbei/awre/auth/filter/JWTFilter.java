...
public class JWTFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest httpServletRequest,
		...
		return getAuthenticationManager()
				.authenticate(new UsernamePasswordAuthenticationToken(account.getName(), account.getPassword()));
	}
	...
	protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		response.getOutputStream()
				.println(JacksonUtil.encode(new Response<String>(ExceptionEnum.TOKEN_VALIDATE_EXCEPTION.getCode(),
						ExceptionEnum.TOKEN_VALIDATE_EXCEPTION.getMessage())));
	}
}
